...
const { generateHashedPassword , comparePasswords } = require('../index');
      
// TEST BCRYPT PASSWORD STRATEGY ...

// {{ endpoint }} / test / authservice / passhash/ bcrypt
...
test_api
  .get('/' , ( req , res ) => res.status( 200 ).send( '{{ endpoint }} / test / authservice / passhash / bcrypt') ) 
